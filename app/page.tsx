...
const departments: Department[] = [
  ...
  { id: "driving-licence", name: "Driving Licence", urdu: "ڈرائیونگ لائسنس", icon: "🚗", description: "Driving licence, learner permit, renewal and testing", services: [
    { id: "learner", name: "Learner Licence", icon: "📝", description: "Apply for a learner licence", question: "How can I apply for a learner driving licence?" },
    { id: "permanent", name: "Permanent Driving Licence", icon: "🚗", description: "Apply for a permanent driving licence", question: "How can I apply for a permanent driving licence?" },
    { id: "renewal", name: "Licence Renewal", icon: "🔄", description: "Renew a driving licence", question: "How can I renew my driving licence?" },
    { id: "duplicate", name: "Duplicate / Lost Licence", icon: "♻️", description: "Replace a lost or damaged licence", question: "How can I get a duplicate driving licence if my licence is lost?" },
    { id: "documents", name: "Required Documents", icon: "📄", description: "Documents for driving licence services", question: "What documents are required for a driving licence?" },
    { id: "fee", name: "Driving Licence Fee", icon: "💰", description: "Current licence fees", question: "What is the current driving licence fee?" },
    { id: "test", name: "Driving Test", icon: "🛣️", description: "Driving test information", question: "What is the driving test procedure for a driving licence?" },
    { id: "online", name: "Online Application", icon: "💻", description: "Online driving licence services", question: "How can I apply for driving licence services online?" },
    { id: "status", name: "Application / Licence Status", icon: "📊", description: "Check licence application or status", question: "How can I check my driving licence application status?" },
  ]},
