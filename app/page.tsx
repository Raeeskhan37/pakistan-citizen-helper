...
questionUr: "میں ڈومیسائل کے لیے کیسے درخواست دے سکتا ہوں؟",
examples: [
{
...
questionEn: "What scholarships are available for Pakistani students?",
questionUr: "پاکستانی طلباء کے لیے کون سی اسکالرشپس دستیاب ہیں؟",
examples: [
{
...
questionEn: "I need information about a government service.",
questionUr: "مجھے ایک سرکاری سروس کے بارے میں معلومات چاہیے۔",
examples: [
{
...
try {
  ...
  /*
   * Accept source information from the API.
   * This also protects against an incomplete source object.
   */
  if (data.source && data.source.url) {
    setSource({
      department: data.source.department,
